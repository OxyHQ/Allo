...
against a real MongoDB replica set, and frontend typecheck plus `jest`. Frontend
typed routes are *not* covered, because `.expo/types/router.d.ts` is generated by
