 ...
 * a JSON parser has run, those bytes are gone. `@crowdsource.you/core/express` looks
 ...
 *
 * `readRawBody` in `@crowdsource.you/core/express` resolves the signed bytes in a
