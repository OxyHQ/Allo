 ...
 * - **The subject is not an Oxy account.** Unreachable for the same reason
 *   (intake decides it) and dead-lettered for the same reason, but it is the one
 *   whose reachable version would be a disclosure rather than a stall.
